...
**Note:** This now returns actual intelligent follow-up questions generated by the DeepSeek LLM.

---

### 4. Generate Follow-up Questions - With Types
**Request:** `POST http://localhost:5000/generate-followup`
...
```json
{
  "followups": [
    {
      "text": "Can you explain why you feel the price is too high compared to the features offered?",
      "type": "reason"
    },
    {
      "text": "How does the high price affect your likelihood of continuing to use or recommend the product?",
      "type": "impact"
    }
  ]
}
...
**Purpose:** Test with specific allowed question types
